...
object UpasthitiUtils {
    ...
    val noClassesMessages = listOf(
        ...
        "NULL pointer exception - no classes detected",
        "Empty array: classes[] = {}",
//    "Error 204: No class content available",
        "SELECT * FROM classes WHERE date = today RETURNED 0 rows",
...
//    "HTTP 204: No class content",
        ...
        "Your attendance streak is safe - there's literally nothing to attend!",
...
//    "Achievement unlocked: Found the mythical 'no classes' day",
        ...
        "Error: Could not locate any reason to leave your room today",
